...
<script setup lang="ts">
  ...
  const handleItemDragStart = (event: DragEvent, itemId: string | number) => {
    console.log('handleItemDragStart', event, itemId)
    ...
    currentDragText.value = item.title
    emit('dragStart', itemId, props.id, item, event.target as HTMLElement)
  }
